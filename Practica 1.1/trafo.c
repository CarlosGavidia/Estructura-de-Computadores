...
/*unsigned char rgb2gray(pixelRGB* pixel)//COMENTADO PARA HACER ENSAMBLADOR
{
...
/*void apply_gaussian(unsigned char im1[], unsigned char im2[], int width, int height)//COMENTADO PARA HACER ENSAMBLADOR
{
	int i,j;
	for (i=0 ; i < height; ++i)
		for (j=0 ; j < width; ++j)
